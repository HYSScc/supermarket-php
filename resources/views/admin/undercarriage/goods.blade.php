                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">下架商品</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="{{ url('admin/undercarriage/goods/' . $goods->gid) }}">
                            {{ csrf_field() }}
                            <div class="box-body">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary">确认下架</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.box -->
