            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('home/goods/list/1') }}"><i class="fa fa-circle-o"></i> 服装类</a></li>
                        <li><a href="{{ url('home/goods/list/2') }}"><i class="fa fa-circle-o"></i> 食品类</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('home/user/orders') }}"><i class="fa fa-circle-o"></i> 订单</a></li>
                    </ul>
                </li>
            </ul>
        </section>
